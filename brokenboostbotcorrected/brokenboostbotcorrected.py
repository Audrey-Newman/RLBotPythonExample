...
class DependableBot(BaseAgent):
    ...
    def initialize_agent(self):
        ...
        self.brokenBoost = True
        self.brokenBoostDetected = False
        self.boostLevelAtBoostCmd = 0
        self.boostTime = time.time()
    ...
    def nextState(self):
        if self.state.val == DEFEND:
            if self.state.expired:
                if self.me.boost < 20 and not self.brokenBoostDetected:
